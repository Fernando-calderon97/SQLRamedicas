-- INSERT TRANSACCIONAL DISPENSACION PUNTOS WEB
INSERT INTO [RamedicasBI].[dbo].[rmd_tradisp_web]
SELECT TOP 100
F.FacSec AS 'facsec',
K.KarSec AS 'karsec',
F.facfec AS 'facfec',
...
K.KarArtEmb AS 'emb',
CASE 
    WHEN K.KarNat = '-' THEN (K.KarUni * -1) 
    ELSE K.KarUni END AS 'und',
K.KarPre AS 'preund',
K.KarArtIva AS 'iva',
CASE
...
WHERE FacTipCod IN ('P10', 'P11', 'P12', 'P13', 'P14', 'P15', 'P16', 'P17', 'PAF', 'PF1', 'PF2', 'PF3', 
'PF4', 'PF5', 'PF6', 'PF7', 'PF8', 'RB1', 'RC1', 'RE3', 'RG4', 'RL2', 'RM5', 
'RM6', 'RMC', 'RQ1', 'RS7', 'RV8')


-- CREATE TABLE TRANSACCIONAL DISPENSACION PUNTOS WEB
USE RamedicasBI
CREATE TABLE rmd_tradisp_web (
    facsec INT NOT NULL,
    karsec INT NOT NULL,
 ...
 CONSTRAINT [pk_rmd_tradisp_web] PRIMARY KEY CLUSTERED 
(
    [facsec] ASC,
    [karsec] ASC
