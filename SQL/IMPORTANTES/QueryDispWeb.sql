...
DECLARE @fecha_inicial_ini_kardex DATETIME = '2024-01-01'
...
--LEFT JOIN Kardex Kar WITH (NOLOCK) ON Fac.FacSec = Kar.FacSec Comentado por que ya existia la relacion KARDEX FACTURA
