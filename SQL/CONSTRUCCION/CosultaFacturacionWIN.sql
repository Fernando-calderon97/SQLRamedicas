...
DISTINCT(prov)
-- prov AS 'nit',
-- nomb AS 'nombre_cliente',
-- arti AS 'codigo_articulo',
...
where t8 in('04','08','NR','19') and (ka4 between '20250101'  and '20250131') and k.ka13 = '806011811-8' /*and 
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250201'  and '20250228') and k.ka13 = '806011811-8'/*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress  
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250301'  and '20250331') and k.ka13 = '806011811-8'/*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250401'  and '20250430') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250501'  and '20250531') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250601'  and '20250630') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250701'  and '20250731') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250801'  and '20250831') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20250901'  and '20250930') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20251001'  and '20251031') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20251101'  and '20251130') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20251201'  and '20251231') and k.ka13 = '806011811-8' /*and 
ka13 in (select n1 from nits where n3 like '85%')*/ --and CAST(PopulationCentre.cdCity AS VARCHAR) like '05%'
) as mc
--group by prov, nomb, arti, month(fech),codciuent,
--ciudent
