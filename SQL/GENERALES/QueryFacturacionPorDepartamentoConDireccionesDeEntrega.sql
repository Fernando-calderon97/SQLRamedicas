...
PopulationCentre.nmPopCentre mundp,
--PopulationCentre.cdCity coddepmun,
ka24 ped,
...
ka13 in (select n1 from nits where n3 like '85%')
...
left join CustomerAddress on f.idcustomeraddress = customeraddress.idcustomeraddress
left join PopulationCentre on customeraddress.idPopCentre = PopulationCentre.idPopCentre
where t8 in('04','08','NR','19') and (ka4 between '20251101'  and '20251118') and 
ka13 in (select n1 from nits where n3 like '85%')
